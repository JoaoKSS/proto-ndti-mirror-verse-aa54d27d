...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden bg-gradient-to-br from-ndti-950 via-ndti-900 to-ndti-800">
      {/* Decorative elements */}
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                href="#servicos" 
                className="px-6 py-3 bg-ifnmg-blue text-white rounded-md hover:bg-ndti-700 hover:shadow-lg hover:shadow-ndti-700/30 transition-all duration-300 flex items-center group"
              >
                Nossos Serviços
              ...
              <a 
                href="#contato" 
                className="px-6 py-3 border border-white/30 text-white rounded-md hover:bg-white/10 hover:border-white/50 backdrop-blur-sm transition-all duration-300 flex items-center group"
              >
                Entre em Contato
          ...
          <div className="md:w-1/2 flex justify-center animate-fade-in-right">
            <div className="relative w-full max-w-md transform transition-all duration-500 hover:scale-105 hover:-rotate-1">
              ...
              <div className="relative bg-ndti-900/50 backdrop-blur-sm p-4 rounded-lg shadow-2xl border border-white/10">
                ...
                <div className="absolute -bottom-4 -right-4 bg-ndti-800/90 backdrop-blur-sm p-3 rounded-full shadow-lg border border-white/10 transition-transform hover:scale-110 hover:rotate-12 cursor-pointer group">
                  <Globe className="w-8 h-8 text-white group-hover:text-ndti-300 transition-colors" />
                </div>
              </div>
            </div>
          </div>
