...
const AboutSection: React.FC = () => {
  const { content, loading, error } = useContentData('home', 'about');
  ...
  return (
    <section id="sobre" className="py-16 sm:py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6">
        <h2 className="section-heading mb-12 sm:mb-16">{content?.title || "Sobre o NDTI"}</h2>
        ...
        <div className="mb-16" ref={textRef}>
          <div className="flex flex-col md:flex-row items-center">
            <div className={cn(
              ...
              <h3 className="text-2xl font-semibold mb-4 text-ndti-800">{content?.subtitle || "Quem Somos"}</h3>
            ...
            <div className={cn(
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-2 sm:p-4 rounded-lg shadow-lg">
                  <img 
                    src={content?.image_url || "https://images.unsplash.com/photo-1531482615713-2afd69097998"}
